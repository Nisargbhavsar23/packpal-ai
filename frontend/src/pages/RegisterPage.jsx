    ...
    <section className="mx-auto grid min-h-[calc(100vh-73px)] max-w-6xl items-center gap-8 px-5 py-12 sm:px-6 lg:grid-cols-[0.95fr_1.05fr]">
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 leading-7 text-slate-600">
          Register once, get signed in automatically, and keep your dashboard protected with the backend JWT
          authentication system.
        </p>
        <div className="mt-6 rounded-xl bg-gradient-to-br from-emerald-50 to-white p-5">
          <p className="text-sm font-semibold text-slate-950">Connected to FastAPI</p>
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Trip, member, and checklist frontend workflows will build on this authenticated session.
          </p>
        </div>
      </div>

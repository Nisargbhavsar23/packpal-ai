  ...
  return (
    <section className="mx-auto grid min-h-[calc(100vh-73px)] max-w-6xl items-center gap-8 px-5 py-12 sm:px-6 lg:grid-cols-[0.95fr_1.05fr]">
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <p className="text-sm font-semibold uppercase tracking-wide text-emerald-700">Secure Reset</p>
        <h1 className="mt-3 text-3xl font-bold tracking-tight text-slate-950">Choose a new password.</h1>
        <p className="mt-4 leading-7 text-slate-600">
          Reset links are single-use and expire after 15 minutes for account safety.
        </p>
      </div>
      ...
      <div className="mx-auto w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/70 sm:p-8">
        ...
        {!token && (
          <div className="mt-5">
            <Alert>Reset token is missing. Please request a new reset link.</Alert>
          </div>
        )}
